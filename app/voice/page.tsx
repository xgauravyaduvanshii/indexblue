...
const VOICE_STORAGE_KEY = "indexblue.voice.selected-voice";
const MUTE_STORAGE_KEY = "indexblue.voice.mic-muted";
const TRANSCRIPT_VISIBLE_KEY = "indexblue.voice.transcript-visible";
                  ...
                  {conversation.slice(-14).map((turn, i) => {
                    ...
                    if (turn.role === "assistant") {
                      return (
                        ...
                        >
                          <span className="font-pixel text-[9px] text-muted-foreground/40 tracking-wider pt-0.5 shrink-0 w-6 text-right">Indexblue</span>
