...
const CATALOG: CatalogItem[] = [
  ...
  {
    name: 'Google Workspace', category: 'productivity', url: 'https://google-mcp.indexblue.app/mcp', auth: 'apikey', maintainer: 'Google', maintainerUrl: 'https://google.com',
    fields: [{
      label: 'API Key', placeholder: 'gmc_…', headerName: 'Authorization',
      hintText: 'Get API key', hintUrl: 'https://google-mcp.indexblue.app',
      steps: [
        { text: 'Go to the Google MCP dashboard and sign in with Google', url: 'https://google-mcp.indexblue.app', urlLabel: 'Open dashboard' },
        { text: 'Google will show an "unverified app" warning — click Advanced → Go to Indexblue (unsafe) to continue. This is expected for developer tools.' },
        ...
        { text: 'To Revoke or Manage the API Key, go to https://google-mcp.indexblue.app/revoke and paste the API key and click "Revoke".' },
      ],
    }],
  },
        ...
        <div className="max-w-5xl mx-auto w-full px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-6 space-y-4">
            <div className="flex items-center justify-center gap-2 relative">
              ...
              <h1 className="text-2xl font-light tracking-tight font-be-vietnam-pro">indexblue apps</h1>
            </div>
