...
const testimonials = [
  {
    content:
      'Indexblue is better than Grok at digging up information from X, its own platform! I asked it 3 different queries to help scrape and find some data points I was interested in about my own account and Indexblue did much much better with insanely accurate answers!',
  ...
  {
    content:
      'Read nothing the whole sem and here I am with Indexblue to top my mid sems! Literally so good to get all the related diagrams, points and topics from the website my professor uses.',
    author: 'Rajnandinit',
      ...
      <div className="flex-1 lg:w-[55%] xl:w-[50%] flex flex-col bg-background lg:border-l lg:border-border/50">
        ...
        <header className="lg:hidden flex items-center justify-between h-16 border-b border-border/50 px-6">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <span className="text-2xl font-light tracking-tighter font-be-vietnam-pro">indexblue</span>
          </Link>
