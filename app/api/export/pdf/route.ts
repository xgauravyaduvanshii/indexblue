...
export async function POST(req: NextRequest) {
  try {
    ...
    // Professional header with Indexblue branding and chat title
    const drawProfessionalHeader = () => {
      ...
      const headerText = title ?? 'Indexblue';
    ...
    // Draw the Indexblue logo (vector) using the same SVG paths as components/logos/scira-logo.tsx
