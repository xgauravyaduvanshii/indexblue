        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between h-14 px-6">
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              <span className="text-lg font-light tracking-tighter font-be-vietnam-pro">indexblue</span>
            </Link>
          ...
          <main>
            ...
            <div className="mb-12 p-5 rounded-2xl border border-primary/15 bg-primary/3">
              ...
              <p className="text-sm text-foreground/80 leading-relaxed">
                Indexblue is free to use with optional paid plans including Pro at $15/mo and Max at $60/mo. Max includes
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none prose-headings:font-be-vietnam-pro prose-headings:font-light prose-headings:tracking-tight prose-h2:text-lg prose-h2:mt-14 prose-h2:mb-4 prose-h2:scroll-mt-20 prose-p:text-muted-foreground prose-p:leading-relaxed prose-p:text-[15px] prose-li:text-muted-foreground prose-li:text-[15px] prose-a:text-foreground prose-a:font-medium prose-a:no-underline hover:prose-a:underline prose-strong:text-foreground prose-strong:font-medium">
              <p className="text-base text-foreground/80 leading-relaxed">
                Welcome to Indexblue. These Terms of Service govern your use of our website and services. By using Indexblue
              ...
              <p>
                By accessing or using Indexblue, you acknowledge that you have read, understood, and agree to be bound by
                these Terms of Service. We reserve the right to modify these terms at any time, and such modifications
                shall be effective immediately upon posting. Your continued use of Indexblue after any modifications
              ...
              <p>
                Indexblue is an AI assistant that helps users research information on the internet and take action
              ...
              <p>You agree not to use Indexblue to:</p>
              <ul>
              ...
              <p>While we strive to provide accurate and reliable information, Indexblue:</p>
              <ul>
              ...
              <p>
                ...
                Indexblue should not be used as the sole source for making important decisions, especially in
              ...
              <p>
                All content, features, and functionality of Indexblue, including but not limited to text, graphics,
                logos, icons, images, audio clips, and software, are the property of Indexblue or its licensors and are
              ...
              <p>Indexblue relies on third-party services to provide its functionality:</p>
              <ul>
              ...
              <p>
                Indexblue offers both free and paid subscription plans. For detailed pricing information, visit our{' '}
              ...
              <ul>
                ...
                <li>
                  <strong>Indexblue Pro:</strong> $15/month subscription with unlimited searches and access to standard paid
                  features and non-Max AI models
                </li>
                <li>
                  <strong>Indexblue Max:</strong> $60/month subscription with all paid features plus Anthropic Claude
                  models, subject to a 60 requests per week usage cap
                </li>
              </ul>
              <p>
                <strong>Important:</strong> Indexblue does not store any payment card details, bank information, or other
              ...
              <p>
                Your use of Indexblue is also governed by our <Link href="/privacy-policy">Privacy Policy</Link>, which
              ...
              <p>
                To the maximum extent permitted by law, Indexblue shall not be liable for any indirect, incidental,
              ...
              <p>
                Indexblue is provided &quot;as is&quot; and &quot;as available&quot; without any warranties of any kind,
              ...
              <p>
                We reserve the right to suspend or terminate your access to Indexblue, with or without notice, for
              ...
              <p>
                <a href="mailto:xgauravyaduvanshii@gmail.com">xgauravyaduvanshii@gmail.com</a>
              </p>
            </div>
            ...
            <div className="mt-16 pt-8 border-t border-border/50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <p className="text-sm text-muted-foreground">
                By using Indexblue, you agree to these Terms and our{' '}
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-8">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-muted-foreground">&copy; {new Date().getFullYear()} Indexblue</span>
            </div>
