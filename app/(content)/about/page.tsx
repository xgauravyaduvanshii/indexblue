...
const testimonials = [
  {
    content:
      'Indexblue is better than Grok at digging up information from X, its own platform! Indexblue did much much better with insanely accurate answers!',
    author: 'Chris Universe',
    handle: '@chrisuniverseb',
  },
  {
    content: 'Indexblue does a really good job scraping through the reddit mines.',
    author: 'nyaaier',
    handle: '@nyaaier',
  },
  {
  ...
  {
    content:
      'Read nothing the whole sem and here I am with Indexblue to top my mid sems! Literally so good to get all the related diagrams, points and topics.',
    author: 'Rajnandinit',
      ...
      <div className="max-w-6xl mx-auto px-6 py-24">
        <div className="text-center mb-16 max-w-xl mx-auto">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Connect 100+ apps via MCP and let Indexblue take action inside them. Research and act, without leaving the
            conversation.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between h-14 px-6">
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              <span className="text-xl font-light tracking-tighter font-be-vietnam-pro">indexblue</span>
            </Link>
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <Link
                href="https://github.com/xgauravyaduvanshii/indexblue"
            ...
            {[
              {
                step: '01',
                title: 'Ask anything',
                description: 'Type a question, upload a PDF, or paste a URL. Pick a mode or let Indexblue decide for you.',
              },
              {
                step: '02',
                title: 'Indexblue plans & retrieves',
                description:
        ...
        <div className="max-w-6xl mx-auto px-6 py-24">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12">
            <div className="max-w-lg">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Each mode is fine-tuned for a specific type of research. Pick one, or let Indexblue choose.
              </p>
            </div>
            <div className="flex items-center gap-3">
      ...
      <section className="border-t border-border/50 bg-muted/20 overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            ...
            <a
              href="https://openalternative.co/indexblue?utm_source=openalternative&utm_medium=badge&utm_campaign=embed&utm_content=tool-indexblue"
              target="_blank"
              className="opacity-50 hover:opacity-100 transition-opacity duration-300"
            >
              <Image
                src="https://openalternative.co/indexblue/badge.svg?theme=dark&width=200&height=50"
                width={150}
                height={38}
                alt="Indexblue badge"
              />
        ...
        <div className="max-w-6xl mx-auto px-6 py-20">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8 max-w-md mx-auto">
              Join 100K+ users who research smarter and get things done with Indexblue.
            </p>
            ...
            <div className="p-8 lg:p-10 flex flex-col rounded-2xl border border-primary/20 bg-card relative overflow-hidden">
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  'Indexblue Apps (100+ integrations)',
                  'PDF analysis',
                  'Voice mode',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                ...
                <a href="mailto:xgauravyaduvanshii@gmail.com" className="text-foreground hover:underline underline-offset-2">
            ...
            <div className="lg:col-span-3">
              <ProAccordion type="single" collapsible className="w-full">
                <ProAccordionItem value="item-1">
                  <ProAccordionTrigger>What is Indexblue?</ProAccordionTrigger>
                  <ProAccordionContent>
                    Indexblue is an open-source AI assistant built for research and action. It searches the web in depth,
                ...
                <ProAccordionItem value="item-5">
                  <ProAccordionTrigger>What AI models does Indexblue use?</ProAccordionTrigger>
                  <ProAccordionContent>
                    Indexblue uses a range of advanced models including Grok, Claude, GPT, Gemini, and more. Switch between
                    them for each query based on what works best.
                  </ProAccordionContent>
                </ProAccordionItem>
                <ProAccordionItem value="item-6">
                  <ProAccordionTrigger>How does Indexblue ensure accuracy?</ProAccordionTrigger>
                  <ProAccordionContent>
                    Indexblue grounds outputs in retrieved sources (RAG + search grounding) and includes inline citations so
