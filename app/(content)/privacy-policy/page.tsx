...
export const metadata: Metadata = {
  ...
  description: 'Indexblue Privacy Policy — how we collect, use, and protect your personal data.',
  alternates: {
    canonical: 'https://indexblue.ai/privacy-policy',
  },
  robots: {
    index: true,
    follow: true,
          ...
          <main>
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none prose-headings:font-be-vietnam-pro prose-headings:font-light prose-headings:tracking-tight prose-h2:text-lg prose-h2:mt-14 prose-h2:mb-4 prose-h2:scroll-mt-20 prose-p:text-muted-foreground prose-p:leading-relaxed prose-p:text-[15px] prose-li:text-muted-foreground prose-li:text-[15px] prose-a:text-foreground prose-a:font-medium prose-a:no-underline hover:prose-a:underline prose-strong:text-foreground prose-strong:font-medium">
              <p className="text-base text-foreground/80 leading-relaxed">
                At Indexblue, we respect your privacy and are committed to protecting your personal data. This Privacy Policy
              ...
              <p>
                <strong>Important Note on Payment Data:</strong> Indexblue does not collect, store, or process any payment
              ...
              <p>
                ...
                <a href="mailto:xgauravyaduvanshii@gmail.com">xgauravyaduvanshii@gmail.com</a>. We will action deletion requests within 30 days,
              ...
              <p><a href="mailto:xgauravyaduvanshii@gmail.com">xgauravyaduvanshii@gmail.com</a></p>
            </div>
            ...
            <div className="mt-16 pt-8 border-t border-border/50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <p className="text-sm text-muted-foreground">
                By using Indexblue, you agree to our Privacy Policy and our{' '}
