...
const PRO_FEATURES = [
  ...
  { icon: Eye, label: 'Indexblue Lookout', description: 'Real-time monitoring' },
];
...
export default function SuccessPage() {
  ...
  const handleClearCache = async () => {
    ...
    try {
      localStorage.removeItem('indexblue-user-data');
    } catch {}
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6 w-full">
      ...
      >
        ...
        {/* Content */}
        <h1 className="text-3xl font-medium text-foreground mb-3 tracking-tight">Welcome to Indexblue {planName}</h1>
