...
`
    : ''
}I am a current student at this university and would love to access the student discount for Indexblue Pro.
...
Best regards`;
  ...
  const handleSubmit = () => {
    ...
    const mailtoLink = `mailto:xgauravyaduvanshii@gmail.com?subject=${encodeURIComponent(subject)}&body=${formattedBody}`;
