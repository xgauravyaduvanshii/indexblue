...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      {
        source: '/ph',
        destination: 'https://www.producthunt.com/posts/indexblue',
        permanent: true,
      },
      {
        source: '/raycast',
        destination: 'https://www.raycast.com/xgauravyaduvanshii/indexblue',
        permanent: true,
      },
      {
        source: '/plst',
        destination: 'https://peerlist.io/xgauravyaduvanshii/project/indexblue-ai-30',
        permanent: true,
      },
      {
        source: '/blog',
        destination: 'https://blog.indexblue.ai',
        permanent: true,
      },
      {
        source: '/askscirabot',
