...
![Indexblue](/app/opengraph-image.png)

<br />

🔗 **[Try Indexblue at indexblue.ai](https://indexblue.ai)**

[![Repository](https://img.shields.io/badge/GitHub-indexblue-black?logo=github)](https://github.com/xgauravyaduvanshii/indexblue)
...
[![Warp](https://github.com/user-attachments/assets/2bda420d-4211-4900-a37e-e3c7056d799c)](https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=indexblue)<br>

### **[Warp, the intelligent terminal](https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=indexblue)**<br>

[Available for MacOS, Linux, & Windows](https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=indexblue)<br>
[Visit warp.dev to learn more](https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=indexblue)

</div>

## How It Works

1. **Ask anything** — Type a question, upload a PDF, or paste a URL. Pick a mode or let Indexblue decide for you.
2. **Indexblue plans & retrieves** — The agent breaks your question into sub-tasks, searches live sources, and cross-checks the evidence.
...
4. **Set the search engine name**:
   - Enter `Indexblue` in the "Search engine" field.

5. **Set the search engine URL**:
   - Enter `https://indexblue.ai?q=%s` in the "URL with %s in place of query" field.
...
After completing these steps, you should be able to use Indexblue as your default search engine in Chrome.
...
2. Build the Docker image:
   ```bash
   docker build -t indexblue.app .
   ```
3. Run the container:
   ```bash
   docker run --env-file .env -p 3000:3000 indexblue.app
   ```
